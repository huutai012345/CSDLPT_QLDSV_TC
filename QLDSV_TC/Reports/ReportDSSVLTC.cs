...
{
    public partial class ReportDSSVLTC : DevExpress.XtraReports.UI.XtraReport
    {
        public ReportDSSVLTC()
        {
            InitializeComponent();
        }

        public ReportDSSVLTC(string NK,int HK,string maMH,string tenMN,int nhom)
        {
            InitializeComponent();
