...
{
    public partial class FormRPBangDiem : Form
    {
        public FormRPBangDiem()
        {
            InitializeComponent();
        ...
        private void btnXem_Click(object sender, EventArgs e)
        {
            ...
            ReportBangDiem rp = new ReportBangDiem(cmbNK.Text,int.Parse(cmbHK.Text),cmbMaMonHoc.SelectedValue.ToString(),cmbMaMonHoc.Text,int.Parse(txtNhom.Text));
